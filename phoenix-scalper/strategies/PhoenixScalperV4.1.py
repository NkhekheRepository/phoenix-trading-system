...
class PhoenixScalperV4_1(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Score ceiling: nullify excessive scores before threshold/override
        dataframe.loc[dataframe["short_score"] > 80, "short_score"] = 0.0
    ...
    def custom_exit(self, pair: str, trade, current_time: datetime,
        ...
        if elapsed > 1:
            logger.info(f"Max hold (1h) reached for {pair}, exiting")
            return "max_hold_1h"
        return None
